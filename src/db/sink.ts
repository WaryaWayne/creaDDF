...
export const memberRowFromRecord = (member: MemberRecord, media: ReadonlyArray<MediaRecord> | null = null) => ({
...
export const officeRowFromRecord = (office: OfficeRecord, media: ReadonlyArray<MediaRecord> | null = null) => ({
  ...
  function* (options?: { readonly runId?: string }) {
    ...
    return {
      ...
      upsertRoom: Effect.fn("DdfDatabaseSyncSink.upsertRoom")(function* () {
        // Property rooms are embedded on ddf_properties.rooms by upsertPropertyGraph.
        yield* Effect.void;
      }),
      upsertMedia: Effect.fn("DdfDatabaseSyncSink.upsertMedia")(function* (
        ...
        if (owner.resource === "Property" || owner.resource === "Member" || owner.resource === "Office") {
          // Property/member/office media are embedded on their owning rows by graph/withMedia upserts.
          return;
        }
