...
describe("normalizers", () => {
  it.effect("normalizes room listing keys without overwriting existing values", () =>
    Effect.gen(function* () {
  ...
  it.effect("normalizes property graphs into property, room, and media groups", () =>
    Effect.gen(function* () {
  ...
  it.effect("normalizes media parent values without overwriting existing values", () =>
    Effect.sync(() => {
